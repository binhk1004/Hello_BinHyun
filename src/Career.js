  ...
  return (
    <div className='carrer-container' id='4'>
          ...
          <Col md='auto' className='carrer'>
            ...
            <div className='carrer_contents'>
              ...
              <div>
                ...
                입니다.<br></br>
                주로 담당했던 업무는 'Python' 을 이용하여 'crawler'를 제작, 'sql
      ...
      <Card style={{ width: '40rem'}}>
        <Card.Img variant='top' className="carrer_image" src="images/carrer1.jpg" />
        <Card.Body>
          <Card.Title>경매이징 (백스테이션)</Card.Title>
          <Card.Text>
            기간 : 2020.07 ~ 2020.12 (6개월)<br></br>
            부동산 경매를 좀 더 쉽게 접할 수 있게끔, 정보를 제공하는 사이트 입니다.<br></br>
            주로 담당했던 업무는 'Python' 을 이용하여 'crawler'를 제작,<br></br>
          ...
          <Card.Text>
            ...
            <li>Beautiful Soup 와 Selenium 을 이용하여 대법원 경매 사이트 내에 다수 조회 물건 및 다수 관심 물건 counting 기능 구현</li>
            <li>대법원 경매 사이트 내에 부동산 매각공고 변경 사항 crawler 제작</li>
            <li>대법원 경매 사이트 내에 물건 상세검색 특이사항 crawler 제작</li>
            <br></br>
            <h7>ORM을 이용한 SQL DB 관리</h7>
            <li>SQL Alchemy를 이용하여 crawler로 발생된 Data 삽입 및 관리</li>
      ...
      <div className="CarrerCard">
      <Card style={{ width: '40rem'}}>
        <Card.Img variant='top' className="carrer_image" src="images/carrer2.png" />
        <Card.Body>
          <Card.Title>에프엘이에스 (FLES)</Card.Title>
          <Card.Text>
            기간 : 2020.12 ~ 2021.03 (4개월)<br></br>
            헬로우운세, 궁타 등 운세 서비스를 제공하는 업체 입니다.<br></br>
            주로 담당했던 업무는 기존 서비스 유지 보수 및 신규 프로젝트 진행을 담당 했습니다.
          </Card.Text>
          <Card.Text>
            <h7>ASP로 제작된 기존 서비스 (헬로우운세, 궁타) 기능 유지 보수</h7>
            <li>ASP로 제작된 기존 서비스 기능 추가 및 유지보수</li>
            <li>MS SQL을 이용한 DB 조작 및 수정</li>
            <br></br>
            <h7>신규 프로젝트 진행</h7>
